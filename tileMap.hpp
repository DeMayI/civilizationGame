...
//The maximum size of the map in chunks, centered around the head chunk
...
class tileMap{
    ...
    public:
        ...
        //Returns detailed information about the location of the tile
        struct tileLocation get_tile_detailed(int x, int y);
        void set_tile(int x, int y, tile* t);
        void set_tile(int x, int y, chunk* c, tile* t);
